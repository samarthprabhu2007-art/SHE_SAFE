...
**sheSafe** is a personal safety and covert-camera detection system built as our Semester 3 Experiential Learning (EL) project at RVCE. It started as a hackathon project (🏆 1st Prize) and is now being developed further into a more research-grade system.

## What it does

Hidden cameras are increasingly used to violate people's privacy in places like hotel rooms, Airbnbs, changing rooms, and washrooms. sheSafe helps a user detect these covert cameras and stay safe using just an ESP32 microcontroller and their smartphone — no extra hardware, no internet dependency, fully portable.
...
3. **IoT Alert & Networking** — A PIR motion sensor for passive intruder detection, plus a one-tap SOS panic button that sends the user's live location to a trusted contact over WhatsApp.
